...
class Email:
    ...
    def login(self):
        with open('login/email_senha.txt', 'r', encoding = 'utf-8') as arquivo:
    ...
    def contentEmail(self):
        with open('email/conteudo.txt', 'r', encoding = 'utf-8') as arquivo:
            for linha in arquivo.read().splitlines():
    ...
    def listEmails(self):
        with open('email/emails.txt', 'r') as arquivo:
            for linha in arquivo.read().splitlines():
                self.emails.append(linha)
